...
public :
   ...
   void launchAllTestFunction()
   {
      ...
      this->printFullTestBegin(ctxout);
      ...
      for(FullNameFunctionMap::iterator itFull = this->m_mapFunction.begin(), itFullEnd = this->m_mapFunction.end(); itFull != itFullEnd; ++itFull)
      {
         ...
         this->printTestCaseBegin(ctxout, prefix, itFull->second.size());
         ...
         for(NameFunctionMap::iterator it = itFull->second.begin(), itEnd = itFull->second.end(); it != itEnd; ++it)
         {
            ...
            this->printTestBegin(ctxout, prefix, suffix) ;
            this->resetErrorRaised();
            (*testFunction)();
            this->printTestEnd(ctxout, prefix, suffix);
            ++count;
         }

         this->printTestCaseEnd(ctxout, prefix, itFull->second.size());
      }
...
#define TEST_F(a, b) class a##_##b : public a { public : void ExecuteTest() ; } ; gtest::TestClassRegistrator<a##_##b> g_TestClassRegistrator_##a##_##b(STRINGIFY(a), STRINGIFY(b)) ; void a##_##b::ExecuteTest()
